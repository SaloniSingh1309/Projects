...
function Banner() {
 ...
 <span className="text-pink-500"> new everyday!! </span> 
  ...
  <p className="text-xl">
    ...
    aliquid neque voluptatibus culpa pariatur aut et, tenetur molestiae 
    sequi in aperiam nobis impedit quidem rerum necessitatibus magni eaque fugiat.
  </p>
  ...
  <img src={banner} className="w-65 h-68" alt="" />
  </div> 
  </div>
  </>
  )
